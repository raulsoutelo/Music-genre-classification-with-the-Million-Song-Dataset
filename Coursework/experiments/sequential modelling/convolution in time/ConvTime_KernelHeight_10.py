...
with tf.name_scope('layer-3'):
    hidden_3, hidden3_weights = fully_connected_layer(hidden_2, (120 - 2*(time_length - 1)) * kernels_2, num_hidden)
...
save_to_file('err_val_ConvTime_KernelHeight_10',  err_val)               
save_to_file('acc_val_ConvTime_KernelHeight_10',  acc_val)
